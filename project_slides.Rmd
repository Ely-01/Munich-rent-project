...
AIC(model_gamma, model_gauss, model1, model2, model3, model_simple)
...
#par(mfrow = c(1, 2))
## Deviance residuals
res_gam_gamma <- residuals(model_gamma, type = "deviance")

# Fitted values (scala risposta)
fit_gam_gamma <- fitted(model_gamma)

plot(fit_gam_gamma, res_gam_gamma,
     xlab = "Fitted values (rent)",
     ylab = "Deviance residuals",
     main = "Gamma GAM: Residui vs Fitted")
abline(h = 0, col = 2)

#qqnorm(res_gam_gamma)
#qqline(res_gam_gamma, col = 2)
...
## Residui (Gaussian GAM)
res_gam_gauss <- residuals(model_gauss, type = "deviance")

## Fitted values (scala del link = log)
fit_gam_gauss <- fitted(model_gauss)

plot(fit_gam_gauss, res_gam_gauss,
     xlab = "Fitted values (rent)",
     ylab = "Deviance residuals",
     main = "Gaussian GAM: Residui vs Fitted")
abline(h = 0, col = 2)

#qqnorm(res_gam_gauss)
#qqline(res_gam_gauss, col = 2)
